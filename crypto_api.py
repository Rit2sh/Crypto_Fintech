...
class CryptoAPI:
    ...
    def get_crypto_prices(self):
        ...
        try:
            ...
            return self.cache or self._get_fallback_prices()
        ...
        try:
            ...
            for coin_id, coin_data in data.items():
                ...
                if symbol:
                    ...
                    if not price_record:
                        price_record = CryptoPrice(symbol=symbol)
